...
<AppLayout>
  <div>
    ...
    <p>This is the Create Experience page for the admin section.</p>
  </div>
  ...
  <div class="my-4">
    <Form
      ...
      :initial-values="{ currently_working: false }"
    >
      ...
      <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        <FormField v-slot="{ componentField, value }" name="end_date">
          <FormItem>
...
import { z } from 'zod'
import { store } from '@/routes/admin/experiences'
